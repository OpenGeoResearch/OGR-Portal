  ...
  <div>
    ...
    >
      ...
      <v-list class="pa-0">
        ...
        <v-list-item
          v-if="this.$auth.loggedIn && this.$auth.user.roles.includes('ROLE_ADMIN') && reportType === 'question'"
          dense
...
import { mdiDotsVertical, mdiAlertOctagon, mdiCheck, mdiAlert, mdiDelete } from '@mdi/js'
import OgrForumInputDialog from './OgrForumInputDialog'
import deleteQuestion from '~/apollo/mutations/deleteQuestion.gql'

export default {
  name: 'OgrForumContentMenu',
  components: { OgrForumInputDialog },
