...
import questionsByAnswerByUsername from '~/apollo/queries/questionsByAnswerByUsername.gql'
...
export default {
  ...
  methods: {
    getQuestions () {
      this.$apollo.query({
        query: questionsByAnswerByUsername,
        variables: {
        ...
        this.questions = response.data.questionsByAnswerByUsername
      })
    }
  }
}
